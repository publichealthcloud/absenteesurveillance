<%@ Page Title="" Language="C#" MasterPageFile="~/manage/communications/messaging/messaging.master" AutoEventWireup="true" CodeFile="dashboard.aspx.cs" Inherits="manage_communications_messaging_dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contents" Runat="Server">
	<div class="breadcrumbs">
		<ul>
			<li>
				<a href="more-login.html">Communications</a>
				<i class="icon-angle-right"></i>
			</li>
			<li>
				<a href="index.html">Text Messaging</a>
                <i class="icon-angle-right"></i>
			</li>
			<li>
