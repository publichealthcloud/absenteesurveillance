<%@ Page Title="" Language="C#" MasterPageFile="~/manage/school-districts/school-district.master" AutoEventWireup="true" CodeFile="daily-school-absentee-data.aspx.cs" Inherits="manage_daily_school_absentee_data" %>
...
<div class="box">
	<div class="box-title">
        ...
        <ul class="tabs">
            <li>
                <div class="btn-group">
                    <a href="/manage/school-districts/daily-school-absentee-data.aspx" class="btn"><i class="icon-refresh"></i> Reload</a> 
		        </div>
            </li>
            <li>
                <div class="btn-group">
