...
public partial class qLrn_user_training_list : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            userTrainings.SelectCommand = "SELECT * FROM qlrn_UserTrainings_View WHERE Available = 'Yes' AND MarkAsDelete = 0 AND TrainingID = " + Request.QueryString["trainingID"] + " AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY Created DESC";
            RadGrid1.PageSize = 250;
            Session["TrainingID"] = Request.QueryString["trainingID"];
        }
        else
            userTrainings.SelectCommand = "SELECT * FROM qlrn_UserTrainings_View WHERE Available = 'Yes' AND MarkAsDelete = 0 AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY Created DESC";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "User_Trainings_" + DateTime.Now;
