...
public partial class manage_campaigns_controls_CampaignMostRecentEnrolled : System.Web.UI.UserControl
{
    ...
    {
        siteData.SelectCommand = "SELECT TOP(10)* FROM qSoc_UserCampaignLanguage_View WHERE MarkAsDelete = 0 AND CampaignID = " + campaign_id + " ORDER BY Enrolled DESC";
