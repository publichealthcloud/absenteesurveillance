<%@ Page Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="campaigns-list.aspx.cs" Inherits="manage_members_campaigns_list" %>
	                ...
	                <div class="box-title">
                        ...
                        <ul class="tabs">
                            <li runat="server" id="liShare">
                                <div class="btn-group">
			                        <a href="/manage/site/learning/campaign-edit.aspx" class="btn btn-primary"><i class="glyphicon-circle_plus"></i> ADD CAMPAIGN</a>
		                        </div>
                            </li>
                            <li>
                                <div class="btn-group">
                    ...
                    <telerik:RadGrid ID="RadGrid1" DataSourceID="siteCampaigns" runat="server" PageSize="50" CaseSensitive="false" GroupingSettings-CaseSensitive="false" AllowSorting="true"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn DataField="ScopeID" HeaderText="Options" AllowFiltering="false" HeaderStyle-Width="75" ItemStyle-Width="75">
                                <ItemTemplate>
			                            <a href="campaign-edit.aspx?campaignID=<%# DataBinder.Eval(Container.DataItem, "CampaignID") %>" class="btn btn-primary" rel="tooltip" title="Manage"><i class="icon-pencil"></i></a>  
                    	                <a target="_blank" href="/social/learning/campaigns/campaign-details.aspx?campaignID=<%# DataBinder.Eval(Container.DataItem, "CampaignID") %>" class="btn" rel="tooltip" title="View in Site"><i class="icon-external-link"></i></a>           
                                </ItemTemplate>
                            ...
                            <telerik:GridBoundColumn HeaderText="CampaignName" HeaderButtonType="TextButton" AutoPostBackOnFilter="true"
                                DataField="CampaignName" HeaderStyle-Width="100" ItemStyle-Width="100" AllowSorting="true" FilterControlWidth="90">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Description" HeaderButtonType="TextButton" AutoPostBackOnFilter="true"
                                DataField="Description" HeaderStyle-Width="250" ItemStyle-Width="250" AllowSorting="true" FilterControlWidth="100">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Code" HeaderButtonType="TextButton" AutoPostBackOnFilter="true"
                                DataField="Code" HeaderStyle-Width="50" ItemStyle-Width="50" AllowSorting="true" FilterControlWidth="40">
                            </telerik:GridBoundColumn>
