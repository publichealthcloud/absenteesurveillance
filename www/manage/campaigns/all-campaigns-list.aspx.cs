...
public partial class manage_manage_all_campaigns_list : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        siteCampaigns.SelectCommand = "SELECT * FROM qSoc_Campaigns WHERE MarkAsDelete = 0 ORDER BY CampaignName ASC";
        lblTitle.Text = "All Campaigns";
