...
public partial class qSoc_blog_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!String.IsNullOrEmpty(Request.QueryString["type"]))
        {
            ...
            siteBlogs.SelectCommand = "SELECT * FROM qSoc_Blogs_View WHERE UploadedFrom='manager' AND Type='" + type + "' AND MarkAsDelete = 0 AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY Created DESC, Title ASC";
            if (type == "story")
            {
            ...
            siteBlogs.SelectCommand = "SELECT * FROM qSoc_Blogs_View WHERE UploadedFrom='manager' AND MarkAsDelete = 0 AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY Created DESC, Title ASC";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Blogs_" + DateTime.Now;
