...
public partial class manage_communications_emails_list : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        siteEmails.SelectCommand = "SELECT * FROM qCom_EmailItems_View WHERE MarkAsDelete = 0 ORDER BY Subject ASC";
        lblTitle.Text = "Emails";
    }
