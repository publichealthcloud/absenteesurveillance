...
public partial class qSoc_video_list : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        siteVideos.SelectCommand = "SELECT * FROM qSoc_Videos_View WHERE Available = 'Yes' AND MarkAsDelete = 0 AND UploadedFrom = 'manager' AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY HighlightedStatus DESC, Created DESC, Title ASC";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Videos_" + DateTime.Now;
