<%@ Page Title="" MasterPageFile="~/manage/manage.master"  Language="C#" AutoEventWireup="true" CodeFile="process-contacts-upload.aspx.cs" Inherits="process_process_contacts_upload" %>
        ...
        <div class="span12">
                    ...
                    <td colspan="2">
                        <div style="padding:15px 10px 15px 10px; background-color:#eee; border-color:darkgray;">
                            ...
                            <blockquote>
                                First Name<br />
                                Last Name<br />
                                <strong>Email</strong> <i>required</i><br />
                                <strong>Keywords</strong> <i>required</i>&nbsp;&nbsp;<i>(type: string, example: group name like Partner or ID like A1005234)</i><br />
                                <strong>Source</strong> <i>required</i>&nbsp;&nbsp;<i>(type: string, example: DPH Mailing List)</i><br />
                                <strong>OkEmail</strong> <i>required</i>&nbsp;&nbsp;<i>(type: string, Yes or No)</i><br />
                                Partner&nbsp;&nbsp;<i>(type: public health)</i><br />
                                MainGroup&nbsp;&nbsp;<i>(type: number, example: 201410)</i><br />
                                SubGroup&nbsp;&nbsp;<i>(type: number, example: 1)</i><br />
                                CustomHTMLElement&nbsp;&nbsp;<i>(type: string, example: california-disclaimer)</i><br />
                            </blockquote>                                      
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="lblFileName" CssClass="NormalItalics" Text="No file selected" runat="server"></asp:Label>&nbsp;&nbsp;<asp:Button CssClass="btn btn-primary" runat="server" ID="btnProcess" Text="Process Contacts" OnClick="btnProcess_OnClick" />
