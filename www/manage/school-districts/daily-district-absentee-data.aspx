<%@ Page Title="" Language="C#" MasterPageFile="~/manage/school-districts/school-district.master" AutoEventWireup="true" CodeFile="daily-district-absentee-data.aspx.cs" Inherits="manage_daily_district_absentee_data" %>
...
<div class="box">
	<div class="box-title">
        ...
        <ul class="tabs">
            ...
            <li>
                <div class="btn-group">
                     <a href="/manage/school-districts/daily-district-absentee-data_extended.aspx" class="btn"><i class="glyphicon-stats"></i> Extended Data</a> 
		        </div>
            </li>
            <li>
                <div class="btn-group">
