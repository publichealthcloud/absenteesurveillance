...
public partial class manage_site_learning_trainings_list : System.Web.UI.Page
{
    ...
    {
        siteTrainings.SelectCommand = "SELECT * FROM qLrn_Trainings_View WHERE MarkAsDelete = 0 ORDER BY Title ASC";
        lblTitle.Text = "All Trainings";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Campaigns_run=" + DateTime.Now;
