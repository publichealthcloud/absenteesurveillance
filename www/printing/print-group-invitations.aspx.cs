...
public partial class qDbs_print_print_family_invitations : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            tableHTML += "<tr>";
            tableHTML += "<td colspan=\"2\" style=\"text-align: center; font-weight:bold; font-size:16px;\"><div style=\"height:15px;\"></div><b>" + audience_name + "</b>";
            tableHTML += "<br /><br /><b>Invitation Code</b><br>";
            tableHTML += "<span style=\"font-weight: bold; font-size: 24px;\">" + code + "<br />";
