...
public partial class tips_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        siteTips.SelectCommand = "SELECT * FROM qSoc_Tips_View WHERE MarkAsDelete = 0 AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY Name ASC";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Articles_" + DateTime.Now;
