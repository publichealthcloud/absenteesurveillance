...
public partial class manage_communications_contacts_list : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        siteContacts.SelectCommand = "SELECT * FROM qCom_Contacts WHERE MarkAsDelete = 0 ORDER BY Email, LastName ASC";
        lblTitle.Text = "All Contacts";
    }
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Contacts_run=" + DateTime.Now;
