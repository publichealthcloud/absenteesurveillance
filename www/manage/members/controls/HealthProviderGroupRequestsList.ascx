<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HealthProviderGroupRequestsList.ascx.cs" Inherits="manage_members_controls_GroupRequestsList" %>
        ...
        <telerik:RadGrid ID="RadGrid1" DataSourceID="siteGroupRequests" runat="server" PageSize="50" CaseSensitive="false" GroupingSettings-CaseSensitive="false" AllowSorting="true"
            ...
            <Columns>
                <telerik:GridTemplateColumn DataField="LastName" HeaderText="Manage" AllowFiltering="false" HeaderStyle-Width="35" ItemStyle-Width="25">
                    <ItemTemplate>
                            <a href="/manage/members/health-provider-group-request-edit.aspx?groupRequestID=<%# DataBinder.Eval(Container.DataItem, "GroupRequestID") %>" class="btn btn-primary" rel="tooltip" title="Manage"><i class="icon-pencil"></i></a> 
                    </ItemTemplate>
                ...
                <telerik:GridBoundColumn HeaderText="Health Provider" HeaderButtonType="TextButton" AutoPostBackOnFilter="true"
                    DataField="HealthProviderName" HeaderStyle-Width="150" ItemStyle-Width="75" AllowSorting="true" FilterControlWidth="50">
                </telerik:GridBoundColumn>
            </Columns>
        </MasterTableView>
