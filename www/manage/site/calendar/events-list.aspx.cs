...
public partial class qSoc_events_list : System.Web.UI.Page
{
    
    protected void Page_Load(object sender, EventArgs e)
    {
        siteEvents.SelectCommand = "SELECT * FROM qSoc_Events WHERE MarkAsDelete = 0 ORDER BY DateTime DESC";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Events_" + DateTime.Now;
