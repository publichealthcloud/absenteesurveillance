<%@ Page Title="" Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="populate-invites-with-data.aspx.cs" Inherits="manage_tools_generate_custom_invitation_codes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="main_features" Runat="Server">
    ...
    <div class="row-fluid">                           
        <div class="span12">
                ...
                <tr>
                    <td colspan="2">
                        <div style="padding:15px 10px 15px 10px; background-color:#eee; border-color:darkgray;">
                            <strong>Instructions:</strong> Download the example file and add your data. You can leave the optional columns blank. <strong>DO NOT remove any columns from the example file.</strong><br />
                            </div>
                            <br />
                            <strong>COLUMNS</strong><br />
                            <blockquote>
                                <strong>InviteCode (Required)</strong><br />
                                FirstName<br />
                                LastName<br />
                                Email<br />
                                Mobile<br />
            ...
            <tr>
                <td colspan="2">
                    <a href="/manage/tools/populate-invites-with-data.aspx" class="btn"><i class="icon-refresh"></i>&nbsp;&nbsp;Restart Upload</a>&nbsp;&nbsp;
