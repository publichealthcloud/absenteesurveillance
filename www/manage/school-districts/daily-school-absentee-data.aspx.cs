...
public partial class manage_daily_school_absentee_data : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(Request.QueryString["schoolID"]))
        {
            ...
            siteSchoolWeeklyAbsenteeData.SelectCommand = "SELECT * FROM qHtl_DailySchoolAbsenteeData WHERE MarkAsDelete = 0 AND SchoolID = " + school_id + " ORDER BY DataDate, School DESC";
        ...
        {
            siteSchoolWeeklyAbsenteeData.SelectCommand = "SELECT * FROM qHtl_DailySchoolAbsenteeData WHERE MarkAsDelete = 0 ORDER BY DataDate, School DESC";
            lblTitle.Text = "All Schools Daily Absentee Data";
        }
