<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" MasterPageFile="~/manage/manage.master" CodeFile="training-edit.aspx.cs" Inherits="edit_training" %>
...
<div style="padding-left:10px;">
    ...
    <div class="box">
		...
		<h3>
            ...
            <ul class="tabs">
                ...
                <li>
                    <div class="btn-group">
                        <a href="training-report.aspx?trainingID=<%= training_id %>" class="btn btn-info"><i class="icon-bar-chart"></i>&nbsp;&nbsp;Training Report</a>
                    </div>
                </li>
                <li>
                    <div class="btn-group">
    ...
    <table border="0" cellpadding="5">
        ...
        <tr>
            ...
            <i class="icon-trash"></i>&nbsp; <asp:LinkButton runat="server" ID="btnDelete" OnClientClick="return confirm('Are you sure you want to delete this training? This action cannot be undone.');" OnClick="btnDelete_Click" Text="Delete Training"></asp:LinkButton>
            </td>
        </tr>
        </asp:PlaceHolder>
        <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator 
                ...
                ErrorMessage="Training title required">
            </asp:RequiredFieldValidator> 
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="Normal">
            <asp:DropDownList ID="ddlTrainingTypes" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTrainingTypes_SelectedIndexChanged">
            </asp:DropDownList>
        ...
        <asp:PlaceHolder ID="plhExtended" runat="server" Visible="false">
    <tr>
        <td width="150" valign="top">
