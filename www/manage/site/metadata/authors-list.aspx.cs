...
public partial class qLrn_author_list : System.Web.UI.Page
{
    
    protected void Page_Load(object sender, EventArgs e)
    {
        siteAuthors.SelectCommand = "SELECT * FROM qLrn_Authors WHERE MarkAsDelete = 0 AND Created > '" + System.Configuration.ConfigurationManager.AppSettings["Solution_StartDate"] + "' ORDER BY AuthorName ASC";
