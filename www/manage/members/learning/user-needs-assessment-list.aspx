<%@ Page Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="user-needs-assessment-list.aspx.cs" Inherits="user_needs_assssment_list" %>
...
<div class="box">
	<div class="box-title">
		<h3>
			<i class="icon-edit"></i>
			<asp:Label ID="lblTitle" runat="server" Text="Page Zones">Member Needs Assessments</asp:Label>
		</h3>
        <ul class="tabs">
            <li>
                <div class="btn-group">
        ...
        <telerik:RadGrid ID="RadGrid1" DataSourceID="userNeedsAssessments" runat="server" PageSize="50" CaseSensitive="false" GroupingSettings-CaseSensitive="false" AllowSorting="true"
            ...
            <GroupByExpressions>
                <telerik:GridGroupByExpression>
                        <SelectFields>
                            <telerik:GridGroupByField FieldAlias="NeedsAssessment" FieldName="Name"></telerik:GridGroupByField>
                        </SelectFields>
                    <GroupByFields>
        ...
        <asp:SqlDataSource ID="userNeedsAssessments" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
