...
public partial class manage_campaign_details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            FileExplorer1.Configuration.ViewPaths = new string[] { 
                string.Format ("~/resources/campaigns/{0}/", campaign_id)
            };

            FileExplorer1.Configuration.DeletePaths = new string[] { 
                string.Format ("~/resources/campaigns/{0}/", campaign_id)           
            };

            FileExplorer1.Configuration.UploadPaths = new string[] { 
                string.Format ("~/resources/campaigns/{0}/", campaign_id)
            };
        }
