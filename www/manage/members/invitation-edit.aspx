<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" MasterPageFile="~/manage/manage.master" CodeFile="invitation-edit.aspx.cs" Inherits="edit_invitation" %>
    ...
    <div class="box">
		...
		<h3>
            ...
            <ul class="tabs">
                ...
                <li>
                    <div class="btn-group">
                        <a href="invitation-edit.aspx?invitationID=<%= invitation_id %>" class="btn"><i class="icon-refresh"></i>&nbsp;&nbsp;Reload</a>
                    </div>
                </li>
                <li>
                    <div class="btn-group">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlInvitationAudience" runat="server" AutoPostBack="true" OnSelectedIndexChanged="loadInviteSettings">
                ...
                <asp:ListItem Value="new moderated group" Text="Create a New Moderated Group"></asp:ListItem>
                <asp:ListItem Value="moderated group" Text="Existing Moderated Group"></asp:ListItem>
                <asp:ListItem Value="new group" Text="New Group"></asp:ListItem>
                <asp:ListItem Value="group" Text="Existing Group"></asp:ListItem>
                <asp:ListItem Value="individual" Text="Individual"></asp:ListItem>
            </asp:DropDownList> 
        </td>
    </tr>
    <asp:PlaceHolder ID="plhSchools" runat="server">
        <tr>
