<%@ Page Language="C#" MasterPageFile="~/manage/manage.master" AutoEventWireup="true" CodeFile="families-list.aspx.cs" Inherits="manage_members_families_list" %>
...
<div class="box">
    ...
    <telerik:RadGrid ID="RadGrid1" DataSourceID="siteFamilies" runat="server" PageSize="50" CaseSensitive="false" GroupingSettings-CaseSensitive="false" AllowSorting="true"
        ...
        <Columns>
            <telerik:GridTemplateColumn DataField="ScopeID" HeaderText="Options" AllowFiltering="false" HeaderStyle-Width="75" ItemStyle-Width="75">
                <ItemTemplate>
			            <a href="family-edit.aspx?familyID=<%# DataBinder.Eval(Container.DataItem, "FamilyID") %>" class="btn btn-primary" rel="tooltip" title="Manage"><i class="icon-pencil"></i></a>            
                </ItemTemplate>
            </telerik:GridTemplateColumn>
            <telerik:GridBoundColumn HeaderText="ID" HeaderButtonType="TextButton" AutoPostBackOnFilter="true" FilterControlWidth="13"
                DataField="FamilyID" HeaderStyle-Width="40" ItemStyle-Width="40" AllowSorting="true">
            </telerik:GridBoundColumn>
            <telerik:GridBoundColumn HeaderText="Family Name" HeaderButtonType="TextButton" AutoPostBackOnFilter="true"
                DataField="FamilyName" HeaderStyle-Width="150" ItemStyle-Width="150" AllowSorting="true" FilterControlWidth="100">
            </telerik:GridBoundColumn>
    ...
    <asp:SqlDataSource ID="siteFamilies" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
