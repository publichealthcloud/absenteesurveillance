<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" MasterPageFile="~/manage/manage.master" CodeFile="topic-edit.aspx.cs" Inherits="edit_topic" %>
...
<div style="padding-left:10px;">
    ...
    <div class="box">
		...
		<h3>
			<i class="icon-edit"></i>
			<asp:Label ID="lblTitle" runat="server" Text="Page Zones">Topics</asp:Label>
		</h3>
            <ul class="tabs">
                <li runat="server" id="li1">
                    <div class="btn-group">  
                        <a href="topics-list.aspx" class="btn"><i class="icon-circle-arrow-left"></i>&nbsp;&nbsp;Back to Topics</a>
                    </div>
                </li>
                <li>
                    <div class="btn-group">
                        <a href="topic-edit.aspx?topicID=<%= topic_id %>" class="btn"><i class="icon-refresh"></i>&nbsp;&nbsp;Reload</a>
                    </div>
                </li>
                <li>
                    <div class="btn-group">
                        <asp:Button ID="btnSave_top" CssClass="btn btn-primary" runat="server" Text="SAVE TOPIC" onclick="btnSave_OnClick" />
                    </div>
                </li>
            </ul>
    ...
    <table border="0" cellpadding="5">
        ...
        <tr>
            ...
            <i class="icon-trash"></i>&nbsp; <asp:LinkButton runat="server" ID="btnDelete" OnClientClick="return confirm('Are you sure you want to delete this topic? This action cannot be undone.');" OnClick="btnDelete_Click" Text="Delete Topic"></asp:LinkButton>
            </td>
        </tr>
        </asp:PlaceHolder>
        <tr>
    ...
    <asp:PlaceHolder ID="plhActiveNav" runat="server" Visible="false">
    <tr>
        <td width="150" class="NormalBold" valign="top">
        Active Site Nav:
        </td>
    ...
    <tr>
        ...
        <td class="Normal">
            <telerik:RadTextBox ID="txtImageURL" runat="server" Width="500px"></telerik:RadTextBox>      
        </td>
    </tr>
    <tr>
        <td width="150" class="NormalBold" valign="top">
        ...
        <td class="Normal">
            <telerik:RadTextBox ID="txtIconURL" runat="server" Width="500px"></telerik:RadTextBox>      
        </td>
    </tr>
    <tr>
        <td width="150" class="NormalBold" valign="top">
...
<div class="box">
    <div class="box-title">
        <ul class="tabs">
            ...
            <li>
                <div class="btn-group">
                    <a href="edit-topic.aspx?topicID=<%= topic_id %>" class="btn"><i class="icon-refresh"></i>&nbsp;&nbsp;Refresh</a>
                </div>
            </li>
            <li>
                <div class="btn-group">
                    <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="SAVE TOPIC" onclick="btnSave_OnClick" />
                </div>
            </li>
        </ul>
