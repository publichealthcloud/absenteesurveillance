<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" MasterPageFile="~/manage/manage.master" CodeFile="school-edit.aspx.cs" Inherits="school_edit" %>
...
<div style="padding-left:10px;">
    <div class="box">
		...
		<h3>
			<i class="icon-edit"></i>
			<asp:Label ID="lblTitle" runat="server" Text="Page Zones">School</asp:Label>
		</h3>
            <ul class="tabs">
                <asp:PlaceHolder ID="plhManagerViewOnly" runat="server">
                <li runat="server" id="li1">
                    <div class="btn-group">  
                        <a href="schools-list.aspx" class="btn"><i class="icon-circle-arrow-left"></i>&nbsp;&nbsp;Back to Schools</a>
                    </div>
                </li>
                </asp:PlaceHolder>
                <li>
                    <div class="btn-group">
                        <a href="school-edit.aspx?schoolID=<%= school_id %>" class="btn"><i class="icon-refresh"></i>&nbsp;&nbsp;Reload</a>
                    </div>
                </li>
                <li>
                    <div class="btn-group">
                        <asp:Button ID="btnSave_top" CssClass="btn btn-primary" runat="server" Text="SAVE SCHOOL" onclick="btnSave_OnClick" />
                    </div>
                </li>
            </ul>
    ...
    <table border="0" cellpadding="5">
        ...
        <tr>
            ...
            <i class="icon-trash"></i>&nbsp; <asp:LinkButton runat="server" ID="btnDelete" OnClientClick="return confirm('Are you sure you want to delete this school? This action cannot be undone.');" OnClick="btnDelete_Click" Text="Delete School"></asp:LinkButton>
            </td>
        </tr>
        </asp:PlaceHolder>
        <tr>
    ...
    <tr>
        ...
        <td valign="top">
            <asp:DropDownList ID="ddlSchoolDistrict" runat="server">
            </asp:DropDownList>
            <asp:RequiredFieldValidator 
                ID="rfvSchoolDistrict" 
                runat="server"
                Text="*"
                ValidationGroup="form" 
                ControlToValidate="ddlSchoolDistrict"
                ErrorMessage="School district is required">
            </asp:RequiredFieldValidator> 
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td valign="top">
            <asp:DropDownList ID="ddlType" runat="server">
                ...
                <asp:ListItem Value="charter" Text="charter"></asp:ListItem>
        ...
        <tr>
            ...
            <td class="Normal">
                <telerik:RadTextBox ID="txtPostalCode" Width="100" runat="server" Mask="######" ResetCaretOnFocus="True"
                    SelectionOnFocus="SelectAll" MaxLength="5" />
                <asp:RequiredFieldValidator 
                    runat="server" 
                    ID="rfvPostalCode" 
                    ValidationGroup="form"
        ...
        <asp:PlaceHolder ID="plhMap" Visible="false" runat="server">
        <tr>
            <td width="200" class="Normal" valign="top">
...
<div class="box">
    <div class="box-title">
        <ul class="tabs">
            ...
            <li>
                <div class="btn-group">
                    <a href="edit-school.aspx?schoolID=<%= school_id %>" class="btn"><i class="icon-refresh"></i>&nbsp;&nbsp;Refresh</a>
                </div>
            </li>
            <li>
                <div class="btn-group">
                    <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" Text="SAVE SCHOOL" onclick="btnSave_OnClick" />
                </div>
            </li>
        </ul>
