...
public partial class comments_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        siteComments.SelectCommand = "SELECT * FROM qSoc_Feed WHERE MarkAsDelete = 0 AND Type = 'comment' AND (OwnerRole = 'Admin' OR OwnerRole = 'Site Admin' OR OwnerRole = 'SiteHost') ORDER BY Created DESC";
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "Thoughts_" + DateTime.Now;
