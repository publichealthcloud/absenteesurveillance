<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default-clean.aspx.cs" Inherits="manage_default" %>
...
<head id="Head1" runat="server">
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="<%= ResolveUrl ("~/manage/img/favicon.ico") %>" />
	<!-- Apple devices Homescreen icon -->
	<link rel="apple-touch-icon-precomposed" href="<%= ResolveUrl ("~/manage/img/apple-touch-icon-precomposed.png") %>" />
